...
import static com.example.sisa.Controller.Boxeo.*;
...
public class Calendario implements Initializable {
    ...
    public void handleDateSelection(ActionEvent actionEvent) {
        ...
        try {
            List<String> lines = Files.readAllLines(Paths.get("src/main/java/com/example/sisa/Ficheros/Jugadores.txt"));
