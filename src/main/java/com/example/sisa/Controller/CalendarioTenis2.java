...
public class CalendarioTenis2 implements Initializable {
    @FXML
    ...
    public CalendarioTenis2() {
    }

    public CalendarioTenis2(Tenis2 tenis2) {
        this.tenis2 = tenis2;
    }


    public void setTenis2(Tenis2 tenis2) {
        this.tenis2 = tenis2;
    }
    //*****************************************************************************************
    ...
    public void handleDateSelection(ActionEvent actionEvent) {
        ...
        try {
            List<String> lines = Files.readAllLines(Paths.get("src/main/java/com/example/sisa/Ficheros/Tenis2.txt"));
            ...
            if (count >= 4) {
                System.out.println("Ya hay 4 jugadores para la fecha seleccionada.");
                return;
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void loadSecondTabContent() {
        ...
        try {
            ...
            loader.setLocation(getClass().getResource("/com/example/sisa/TablaJugadoresTenis2.fxml"));
            Parent root = loader.load();

            // Inicia calendarioController
            TablaJugadoresTenis2 controller = loader.getController();
    ...
    public void eventYesOrNot(ActionEvent actionEvent) {
        ...
        if (disponibilidad.getText().equals("Disponible")) {
            ...
            try (FileWriter writer = new FileWriter("src/main/java/com/example/sisa/Ficheros/Tenis2.txt", true)) {
