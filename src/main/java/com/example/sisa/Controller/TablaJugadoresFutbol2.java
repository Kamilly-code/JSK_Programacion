...
public class TablaJugadoresFutbol2 implements Initializable {
    @FXML
    ...
    public void setCalendarioController(CalendarioFutbol2 calendarioController) {
    ...
    private void start(Stage stage) {
       //ObservableList<Jugadores> listaJugadores = calendarioController.getJugadores();
        ...
        try (Scanner scanner = new Scanner(new File("src/main/java/com/example/sisa/Ficheros/Futbol2.txt"))) {
