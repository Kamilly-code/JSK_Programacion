...
public class TablaJugadoresTenis1 implements Initializable {
    @FXML
    ...
    public void setCalendarioController(CalendarioTenis1 calendarioController) {
    ...
    private void start(Stage stage) {
       //ObservableList<Jugadores> listaJugadores = calendarioController.getJugadores();
        ...
        try (Scanner scanner = new Scanner(new File("src/main/java/com/example/sisa/Ficheros/Tenis1.txt"))) {
