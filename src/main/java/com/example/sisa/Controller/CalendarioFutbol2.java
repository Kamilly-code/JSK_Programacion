...
public class CalendarioFutbol2 implements Initializable {
    @FXML
    ...
    public CalendarioFutbol2() {
    }

    public CalendarioFutbol2(Futbol2 futbol2) {
        this.futbol2 = futbol2;
    }

    public void setFutbol2(Futbol2 futbol2) {
        this.futbol2 = futbol2;
    }
    ...
    public void handleDateSelection(ActionEvent actionEvent) {
        ...
        try {
            List<String> lines = Files.readAllLines(Paths.get("src/main/java/com/example/sisa/Ficheros/Futbol2.txt"));
            ...
            if (count >= 10) {
                System.out.println("Ya hay 10 jugadores para la fecha seleccionada.");
                return;
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void loadSecondTabContent() {
        ...
        try {
            ...
            loader.setLocation(getClass().getResource("/com/example/sisa/TablaJugadoresFutbol2.fxml"));
            Parent root = loader.load();

            // Iniciar calendarioController
            TablaJugadoresFutbol2 controller = loader.getController();
    ...
    public void eventYesOrNot(ActionEvent actionEvent) {
        ...
        if (disponibilidad.getText().equals("Disponible")) {
            ...
            try (FileWriter writer = new FileWriter("src/main/java/com/example/sisa/Ficheros/Futbol2.txt", true)) {
