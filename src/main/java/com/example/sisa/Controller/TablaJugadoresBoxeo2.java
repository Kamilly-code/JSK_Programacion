...
public class TablaJugadoresBoxeo2 implements Initializable {
    @FXML
    ...
    public void setCalendarioController(CalendarioBoxeo2 calendarioController) {
    ...
    private void start(Stage stage) {
       //ObservableList<Jugadores> listaJugadores = calendarioController.getJugadores();
        ...
        try (Scanner scanner = new Scanner(new File("src/main/java/com/example/sisa/Ficheros/JugadoresBoxeo2.txt"))) {
