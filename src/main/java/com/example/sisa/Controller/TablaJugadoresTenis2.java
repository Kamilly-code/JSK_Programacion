...
public class TablaJugadoresTenis2 implements Initializable {
    @FXML
    ...
    private CalendarioTenis2 calendarioController;
    ...
    public void setCalendarioController(CalendarioTenis2 calendarioController) {
    ...
    private void start(Stage stage) {
       //ObservableList<Jugadores> listaJugadores = calendarioController.getJugadores();
        ...
        try (Scanner scanner = new Scanner(new File("src/main/java/com/example/sisa/Ficheros/Tenis2.txt"))) {
